...
Make a copy of the `.env.example` file as `.env` and update the `DATABASE_HOST`, `DATABASE_USERNAME`, and `DATABASE_PASSWORD` properties using the properties of the password you just generated.
